...
function buildr_customize_preview_js() {
    wp_enqueue_style( 'buildr-customizer-preview-style', get_template_directory_uri() . '/assets/admin/css/customizer-preview.css', DESIGNR_VERSION, null );
    wp_enqueue_script( 'buildr-customizer-preview-script', get_template_directory_uri() . '/assets/admin/js/customizer-preview.js', array ( 'jquery', 'customize-preview' ), DESIGNR_VERSION, true );
}
add_action( 'customize_preview_init', 'buildr_customize_preview_js' );


function buildr_customize_controls_js() {
    wp_enqueue_script( 'buildr-customizer-control', get_template_directory_uri() . '/assets/admin/js/customizer-control.js', array ( 'jquery', 'customize-controls' ), DESIGNR_VERSION, true );
    wp_enqueue_style( 'buildr-customizer-style', get_template_directory_uri() . '/assets/admin/css/customizer.css', DESIGNR_VERSION, null );
}
